...
description: Answer questions about [DOMAIN] without coding
argument-hint: [question]
---

# [DOMAIN] Expert - Question Mode

Answer the user's question by analyzing the [DOMAIN] implementation. This is a question-answering task only - DO NOT write, edit, or create any files.

## Variables

- USER_QUESTION: $1
- EXPERTISE_PATH: .claude/commands/experts/_template/expertise.yaml

## Instructions

1. Focus on [DOMAIN]-related functionality
