...
description: Answer questions about the Orchestrator workflow without coding
argument-hint: [question]
---

# Orchestrator Expert - Question Mode

Answer the user's question by analyzing the Orchestrator - the central workflow coordinator in Salesbooster. This is a question-answering task only - DO NOT write, edit, or create any files.

## Variables

- USER_QUESTION: $1
- EXPERTISE_PATH: .claude/commands/experts/orchestrator/expertise.yaml

## Instructions

1. Focus on Orchestrator functionality: event handling, workflows, service coordination
